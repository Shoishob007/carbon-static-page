      ...
      <div className="relative h-full flex justify-center overflow-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center w-full max-w-2xl lg:max-w-3xl bg-transparent backdrop-blur-md py-8 sm:py-12">
          <div className="logo my-3 sm:my-4">
            <FaLeaf className="text-5xl lg:text-6xl text-emerald-700 mx-auto" />
          </div>

          <div className="flex flex-col justify-center items-center px-4">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-emerald-700 mb-2 sm:mb-3">
          ...
          <div className="px-4 sm:px-6">
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 mt-6 mb-2 sm:mt-8 sm:mb-4 lg:mb-6">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 mb-8 sm:mb-10">
            ...
            <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl text-emerald-700 mb-4 sm:mb-6 font-semibold">
              Launching Soon!
            </h2>
            ...
            <form onSubmit={handleSubmit} className="max-w-md md:max-w-lg lg:max-w-xl mx-auto mb-4 sm:mb-6">
              <div className="flex flex-col gap-4 sm:gap-5">
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-white/90 rounded-lg border border-gray-300 focus:outline-none focus:ring-0 text-gray-800 h-[100px] sm:h-[120px] md:h-[140px] lg:h-[150px] text-sm sm:text-base md:text-lg lg:text-xl placeholder:text-sm sm:placeholder:text-base md:placeholder:text-lg lg:placeholder:text-xl"
                  required
                  value={enquiry}
                ...
                <button
                  type="submit"
                  className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2 sm:py-3 rounded-lg transition-colors flex items-center justify-center text-sm sm:text-base md:text-lg lg:text-xl"
                >
